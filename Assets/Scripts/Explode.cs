...
public class Explode : MonoBehaviour {
  ...
  [Space(8)]
	...
	void Start() {
		...
		piecesMaterial = piecesMaterial ? piecesMaterial : transform.GetComponent<Renderer>().materials[0];
	}

	public void Detonate(float explosionRadius, Material material = null, GameObject shatter = null, float force = -1, int pieces = -1) {
		material = material ? material : piecesMaterial;
		shatter = shatter ? shatter : shatterPrefab;
